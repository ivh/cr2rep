        ...
        cpl_table   **  sub_trace_wave)
{
    ...
    if (trace_wave == NULL | nb_subtraces <= 0 | sub_trace_wave == NULL) 
        return -1;
    ...
    *sub_trace_wave = cpl_table_new(nb_subtraces);
    ...
    for (i = 0; i < nb_subtraces; i++){
        ...
        res = cr2res_util_get_subtrace(trace_wave, pos, height, order, &bottom,
