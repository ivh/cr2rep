...
raw_standard = (data_source('STANDARD_STAR')
                ...
                .with_grouping_keywords(group_cal_common + [kwd.dpr_tech, kwd.dpr_type])
                .with_setup_keywords(match_flat + [kwd.dpr_type])
...
raw_science_2d_object = (data_source('SCIENCE_2D')
