...
match_dark_for_calibs = (match_rules()
                         .with_match_keywords(setup, time_range=RelativeTimeRange(0, 0.1), level=0)
                         .with_match_keywords(setup, time_range=RelativeTimeRange(0, 1.0), level=1)
...
raw_flat = (data_source('FLAT')
            ...
            .with_match_function(rules.assoc_flat, time_range=ONE_DAY, level=0)
            .with_match_function(rules.assoc_flat, time_range=RelativeTimeRange(-2.5, 2.5), level=1)
...
match_flat_sc2d = (match_rules()
                   .with_match_keywords(match_flat, time_range=ONE_WEEK, level=0)
                   .with_match_keywords(match_flat, time_range=RelativeTimeRange(-10, 10), level=1)
                   .with_match_keywords(match_flat, time_range=UNLIMITED, level=3))
